...
$(function() {
    ...
    $(".img-c").click(function() {
        ...
        $(".gal-active").not($(this)).remove();
        let copy = $(this).clone();
        copy.insertAfter($(this)).height(h).width(w).delay(500).addClass("gal-active");
        $(".gal-active").css('top', y - 228);
        $(".gal-active").css('left', x - 285);
...
$(document).on("click", ".img-c.gal-active", function() {
    let copy = $(this);
    copy.removeClass("positioned gal-active").addClass("postactive");
    setTimeout(function() {
        copy.remove();
    }, 500)
})
